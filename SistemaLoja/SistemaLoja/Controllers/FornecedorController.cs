...
namespace SistemaLoja.Controllers
{
    public class FornecedorController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "FornecedorId,Nome,Telefone,Endereco,Email")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "FornecedorId,Nome,Telefone,Endereco,Email")] Fornecedor fornecedor)
        {
            if (ModelState.IsValid)
            {
